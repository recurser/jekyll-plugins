...
You should also copy the _category_index.html_ file from the _layouts_ directory of this _jekyll-plugins_ project to the <em>_layouts</em> directory of your own project. This file is provided as an example layout, and obviously you can change the HTML above as you see fit.
