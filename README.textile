...
You should also copy the _category_index.html_ file from the _layouts_ folder of the _jekyll-plugins_ project to the _layouts folder of your own project. This file is provided as an example layout, and obviously you can change the HTML above as you see fit.
